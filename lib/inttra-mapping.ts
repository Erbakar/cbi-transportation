...
export function mapInttraManual(m:Manual){
 ...
 return {Vessel:m.vessel,Voyage:m.voyage,MoveTypeCode:move.value,MoveTypeDesc:move.label,PaymentInstructions:payment,SIReferences:{...(m.houseBillNumber?{HouseBillNumber:{HouseBillNumber_1:reference(m.houseBillNumber,'16','House Bill of Ladding Number')}}:{}),CarrierBookingNumber:{CarrierBookingNumber_1:reference(m.bookingNumber,'4','Carrier Booking Reference')},BLReferenceNumber:{BLReferenceNumber_1:reference(m.blReference,'8','Bill Of Lading Reference')}}};
}
