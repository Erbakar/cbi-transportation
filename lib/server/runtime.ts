...
export type Runtime={DB:D1Database;BUCKET:R2Bucket;APP_USERNAME?:string;APP_PASSWORD_HASH?:string;ENCRYPTION_KEY?:string;OPENAI_API_KEY?:string;OPENAI_MODEL?:string;PLATFORM_CONTRACTS?:string;TRUSTED_PARTIES?:string};
