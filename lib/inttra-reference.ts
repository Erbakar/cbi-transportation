...
export function exactOption(options:Option[],value:string,kind:string){
 ...
 const aliases:Record<string,string>={'40HC':'40 High Cube','40HQ':'40 High Cube','40DC':'40 Standard Dry','20DC':'20 Standard Dry','20GP':'20 Standard Dry','40GP':'40 Standard Dry','PACKAGES':'Package','PACKS':'Package','PKG':'Package','BOXES':'Box','CARTONS':'Carton','PALLETS':'Pallet'};
